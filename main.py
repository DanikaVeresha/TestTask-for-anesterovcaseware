...
# Завдання полягає в організації циклу обробки бухгалтерських записів із локальної бази даних до готового файлу у форматі XML,
# придатного для подальшого обміну або архівування.
#
...
# Нормалізація дат: приведення всіх дат до одного стандартного вигляду (ISO YYYY-MM-DD),
# незалежно від вихідного формату (європейського, американського, часових позначок тощо); –
